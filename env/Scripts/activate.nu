...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Silabuz\repositorio-portafolio\Portafolio\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Silabuz\repositorio-portafolio\Portafolio\env\Scripts\deactivate.nu'
